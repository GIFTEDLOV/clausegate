...
export default function SubmitProposalPage() {
  ...
  return <AppShell><section className="container app-main"><div className="form-layout">
    ...
    <form onSubmit={submit} className="form-surface"><div className="form-section">
      ...
      {version === "1" && <div className="form-error">Production v1 remains available for claim-based submissions. Evidence-bound certificates require a separately configured v2 test contract; production is not being repointed.</div>}
