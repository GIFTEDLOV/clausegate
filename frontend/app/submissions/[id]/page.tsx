...
const supportingCopy = { COMPLIANT: "This proposal was accepted against the published Rulebook.", NON_COMPLIANT: "This proposal did not satisfy the published Rulebook.", UNCLEAR: "Validators could not reach a defensible compliance decision from the submitted text." };
